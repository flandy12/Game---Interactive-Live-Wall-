...
@section('content')
    <!-- STAGE -->
    <div id="stage" class="relative w-screen h-screen bg-master overflow-hidden z-0"></div>
    ...
    <script>
        ...
        const CHARACTERS = [{
                ...
                frames: [
                    ...
                    '/images/CHAR-01/image-05.png',
                    '/images/CHAR-01/image-06.png',
                    '/images/CHAR-01/image-07.png',
                    '/images/CHAR-01/image-08.png',
                ],
                width: 200,
                speed: 0.8
            },
            {
                ...
                frames: [
                    ...
                    '/images/CHAR-02/image-05.png',
                    '/images/CHAR-02/image-06.png',
                    '/images/CHAR-02/image-07.png',
                    '/images/CHAR-02/image-08.png',
                ],
                width: 200,
                speed: 1.1
            },
